...
On entend souvent parler de santé connectée et il existe pléthore de nouvelles applications pour suivre notre sommeil, nos performances sportives, nos pas dans la journée, notre alimentation ou encore notre poids... Voici une application pour smartphone gratuite, utile et bien conçue : [Clue](https://helloclue.com/fr/).

![Clue iPhone et Android](/assets/2014-12-23/Clue-iPhone-Android.png)

Cette application est disponible pour [Android](https://play.google.com/store/apps/details?id=com.clue.android) et [iOS - iPhone](https://apps.apple.com/fr/app/clue-period-tracker-fertility/id657189652). Elle est anonyme : il n'y a pas besoin de s'enregistrer pour l'utiliser et vous pouvez mettre un mot de passe pour sécuriser son ouverture.

Elle permet de suivre votre [cycle menstruel](https://fr.wikipedia.org/wiki/Cycle_menstruel) et de le visualiser grâce à une image interactive indiquant les dates estimées de :
...
Pour celles qui pratiquent la contraception naturelle avec la [symptothermie](https://sympto.org/3/fr/shop/manuels/la-symptothermie-complete-edition-nouvelle), l'application [Sympto](https://apps.apple.com/fr/app/sympto-stars/id1606728418) est préférable.
